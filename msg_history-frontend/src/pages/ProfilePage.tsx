                    ...
                    <Col lg={8}>
                        <Card className="shadow-sm border-0 rounded-4">
                            <Card.Header className="bg-white border-0 pt-4 pb-0 px-4 d-flex justify-content-between align-items-center">
                                <h3 className="fw-bold mb-0" style={{ color: '#000' }}>Личный кабинет</h3>
                                {user.moderator && (
                            ...
                            <Card.Body className="p-4">
                                <div className="d-flex align-items-center mb-4 pb-4 border-bottom">
                                    <div className="me-4">
                                        <PersonCircle size={80} color="#999" />
                                    </div>
                                    <div>
                                ...
                                <Form>
                                    <Row className="g-3">
                                        <Col md={6}>
                                            <Form.Group>
                                                <Form.Label style={{ fontWeight: '500' }}>ФИО</Form.Label>
                                                <Form.Control
                                                    type="text"
                                                    value={isEditing ? editData.full_name : user.full_name || ''}
                                                    onChange={(e) => setEditData({ ...editData, full_name: e.target.value })}
                                                    disabled={!isEditing}
                                                    className={isEditing ? 'border-primary' : 'bg-light'}
                                                />
                                            </Form.Group>
                                        </Col>
                                        ...
                                        <Col md={6}>
                                            <Form.Group>
                                                <Form.Label style={{ fontWeight: '500' }}>Логин</Form.Label>
                                                <Form.Control
                                                    type="text"
